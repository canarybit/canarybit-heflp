...
def load_data(cid:int=0, total_n: int=2, timesteps:int=10):
    ...
    if total_n == 2:
        input_data_folder_path=os.path.join(os.path.dirname(os.getcwd()), data_directory, str(0))
...
if __name__ == '__main__':
    ...
    if if_training:
        ...
        runner = LSTMRunner(X_train, X_test, X_test_reshaping, cols, 'mse', optimizer, 700)
    else:
        '''If test only:'''
